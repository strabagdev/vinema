...
resolucion avanzada de conflictos, IA y busqueda global remota o semantica.
...
VINEMA_ALLOWED_ORIGINS=http://localhost:3000,http://tauri.localhost,tauri://localhost
PORT=8000
```
